...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($error_msg) && empty($phone_err)) {
        ...
        $query = "INSERT INTO inspirational_design_forms (Name, PhoneNumber, Email, Message) 
        ...
        if (mysqli_query($con, $query)) {
            ...
            try {
                ...
                $mail->setFrom('balaabimanyugnc@gmail.com', 'Insiprational Design Homes');
                $mail->addAddress('balaabimanyugnc@gmail.com', 'Insiprational Design Homes');
                $mail->isHTML(true);
                $mail->Subject = 'Insiprational Design Homes Inquiry';
                $mail->Body = $html;
                ...
                $userMail->setFrom('balaabimanyugnc@gmail.com', 'Insiprational Design Homes');
                $userMail->addAddress($Email, $Name);
                $userMail->isHTML(true);
                $userMail->Subject = 'Thank You for Contacting Us';
                $userMail->Body = "
                    Hi <b>$Name</b>,<br><br>
                    Thank you for reaching out to <b>Insiprational Design Homes</b>.<br>
                    We have received your inquiry and will get back to you shortly.<br><br>
                    Regards,<br>
                    Insiprational Design Homes Team";
                ...
                $subject = 'Insiprational Design Homes Inquiry';
